...
public class ProgramarSesionEntrenamientoController {
    ...
    void programarSesion(ActionEvent event) throws IOException{
        ...
        if((codigo != null && !codigo.isBlank()) && (fecha != null) && (hora != null) && (duracion != null) && (entrenador != null) && (deporte != null)){
            ...
            if(!(buscarMismaFechaYHora(entrenador, fechaYHora).isPresent())){
                ...
                codigotxt.setText(""); fechapicker.setValue(LocalDate.now()); horatxt.setText(""); duraciontxt.setText(""); nombreentrenadortxt.setText(""); nombreentrenadortxt.setText("");
            }else{
